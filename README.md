...
- **Заметки**
  ...
  - **категории (Outlook-style)**: без категории, жёлтая, зелёная, красная, лиловая, оранжевая, синяя
- **Напоминания**
  - **время начала события** + **"Напомнить за"** (0/5/10/15/30 мин, 1/2/4 часа, 1 день, 1 неделя)
  - всплывающее окно уведомления с темой и корректным масштабированием
  - **кнопка "Отложить" (Outlook-style)**: 5/10/15/30 мин, 1/2/4 часа, 1 день, 1 неделя
